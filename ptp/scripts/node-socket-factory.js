...
define([
    ...
    internalProto.open = function () {
        ...
        this.client = net.createConnection({
            ...
            console.log("node.socket.on:connect");
        ...
        this.client.on('data', function (data) {
            //console.log("node.socket.on:data:" + data);
            internal.onData(dataFactory.create(data));
        });

        this.client.on('error', function (error) {
            internal.client.destroy();
            internal.client.unref();
            console.log("node.socket.on:error:" + error);
            internal.isConnecting = false;
        ...
        this.client.on('close', function () {
            internal.client.destroy();
            internal.client.unref();
            console.log("node.socket.on:close");
            internal.isConnecting = false;
        ...
        this.client.on('drain', function () {
            console.log("node.socket.on:drain");
            internal.onDrain();
        });
