...
define([
	...
	'./photo-capture', './send-host-request',
    './get-storage-ids', './get-device-info', './open-session'
             ...
             objectFormatCodes, photoCapture, sendHostRequest,
             getStorageIds, getDeviceInfo, openSession) {
    'use strict';
    ...
    return Object.create(null, {
        ...
        forceDisconnect: {value: connection.forceDisconnect},
        ...
        onCameraEvent: {set: function (x) {
            eventLoop.cameraEventCallbacks.push(x);
        }},
        host: {set: function (x) {
        ...
        sendHostRequest: {value: sendHostRequest},
        getStorageIds: {value: getStorageIds},
        getDeviceInfo: {value: getDeviceInfo},
        photoCapture: {value: photoCapture},
